...
WebUI.click(findTestObject('createProfile/input_status_activeLooking'))

WebUI.click(findTestObject('createProfile/input_status_giveAccessResume'))

WebUI.setText(findTestObject('createProfile/input_Keyword Search_keyword_search'), 'fresh graduate')
