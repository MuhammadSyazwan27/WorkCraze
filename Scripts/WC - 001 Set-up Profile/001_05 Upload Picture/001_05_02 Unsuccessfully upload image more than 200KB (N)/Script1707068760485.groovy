...
WebUI.uploadFile(findTestObject('createProfile/input_Image_image'), picture)

WebUI.verifyElementPresent(findTestObject('createProfile/div_Error  File Size is large From 200KB'), 0)
